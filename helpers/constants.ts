...
const {
  ...
  version: string;
} = require("@zerolendxyz/core-v3/package.json");
const {
  version: peripheryVersion,
}: {
  _resolved: string;
  version: string;
} = require("@zerolendxyz/periphery-v3/package.json");
...
export const WRAPPED_NATIVE_TOKEN_PER_NETWORK: { [network: string]: string } = {
  ...
  [eZkSyncNetwork.zkGoerli]: "0x294cB514815CAEd9557e6bAA2947d6Cf0733f014",
  [eZkSyncNetwork.zkEra]: "0x5AEa5775959fBC2557Cc8789bC1bf90A239D9a91",
...
export const chainlinkAggregatorProxy: Record<string, string> = {
  ...
  [eZkSyncNetwork.zkEra]: "0x517F9cd13fE63e698d0466ad854cDba5592eeA73",
  [eZkSyncNetwork.zkGoerli]: "0x36A542F6dEB68381646BF52024a888AEa3345546",
...
export const POOL_ADMIN: Record<string, string> = {
  ...
  [eZkSyncNetwork.zkGoerli]: "0xb76F765A785eCa438e1d95f594490088aFAF9acc",
  [eZkSyncNetwork.zkEra]: "0xb76F765A785eCa438e1d95f594490088aFAF9acc",
  [eBSCNetwork.bsc]: "0xb76F765A785eCa438e1d95f594490088aFAF9acc",
};
